...
class Registration_form_template extends Registration_form
{
	...
	function addWooCommerceBillingAddress()
	{
		if ($this->woocommerce_and_piereg_wc_addon_active)
		{
			...
			$selectedoption 	= (isset($wc_billing_address_values['country']) && $wc_billing_address_values['country']) ? $wc_billing_address_values['country'] : (isset($this->field['default_country']) ? $this->field['default_country'] : "" );		 
	...
	function addWooCommerceShippingAddress()
	{
		if ($this->woocommerce_and_piereg_wc_addon_active)
		{
			...
			$selectedoption 	= ( isset($wc_shipping_address_values['country']) && $wc_shipping_address_values['country'] ) ? $wc_shipping_address_values['country'] : (isset($this->field['default_country']) ? $this->field['default_country'] : "" ); 
			$country_options 	= $this->createDropdown($countries,$selectedoption);  
