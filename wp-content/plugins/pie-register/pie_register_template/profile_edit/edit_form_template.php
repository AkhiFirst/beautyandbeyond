...
class Edit_form_template extends Edit_form
{
	...
	function addWooCommerceBillingAddress()
	{
		if ($this->woocommerce_and_piereg_wc_addon_active)
		{
			...
			// country_options
			$countries 			= get_option("pie_countries");
			$selectedoption 	= (isset($wc_billing_address_values['country']) && $wc_billing_address_values['country'])?$wc_billing_address_values['country']:$this->field['default_country'];		 
			$country_options 	= $this->createDropdown($countries,$selectedoption);  

			// us_states_options
			$us_states 			= get_option("pie_us_states");
			$selectedoption 	= (isset($wc_billing_address_values['state']))?$wc_billing_address_values['state']:$this->field['us_default_state'];
			$us_states_options 	= $this->createDropdown($us_states,$selectedoption);
			
			// can_states_options
			$can_states 		= get_option("pie_can_states");
			$selectedoption 	= (isset($wc_billing_address_values['state']))?$wc_billing_address_values['state']:$this->field['canada_default_state'];
			$can_states_options = $this->createDropdown($can_states,$selectedoption);
			...
			$arguments = array(
				...
				'addDesc' 						=> $addDesc, 
				'wc_billing_address_values' 	=> $wc_billing_address_values, 
				'country_options' 				=> $country_options, 
				'us_states_options' 			=> $us_states_options, 
				'can_states_options' 			=> $can_states_options
			);
	...
	function addWooCommerceShippingAddress()
	{
		if ($this->woocommerce_and_piereg_wc_addon_active)
		{
			...
			// country_options
			$countries 			= get_option("pie_countries");
			$selectedoption 	= (isset($wc_shipping_address_values['country']) && $wc_shipping_address_values['country'])?$wc_shipping_address_values['country']:$this->field['default_country'];		 
			$country_options 	= $this->createDropdown($countries,$selectedoption);  

			// us_states_options
			$us_states 			= get_option("pie_us_states");
			$selectedoption 	= (isset($wc_shipping_address_values['state']))?$wc_shipping_address_values['state']:$this->field['us_default_state'];
			$us_states_options 	= $this->createDropdown($us_states,$selectedoption);
			
			// can_states_options
			$can_states 		= get_option("pie_can_states");
			$selectedoption 	= (isset($wc_shipping_address_values['state']))?$wc_shipping_address_values['state']:$this->field['canada_default_state'];
			$can_states_options = $this->createDropdown($can_states,$selectedoption);
			...
			$arguments = array(
				...
				'addValidation' 				=> $addValidation, 
				'addDesc' 						=> $addDesc, 
				'wc_shipping_address_values' 	=> $wc_shipping_address_values, 
				'country_options' 				=> $country_options, 
				'us_states_options' 			=> $us_states_options, 
				'can_states_options' 			=> $can_states_options
			);
