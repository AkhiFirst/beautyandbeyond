        ...
        <div class="fields">
          ...
          <div class="cols-3">
            ...
            <?php } else { ?>
                ...
                <span style="text-align:left;" class="note pie_usage_note" style="color:red;">
                    <?php _e("Define invitation code expiry date here. Leaving it empty means that the invitation code will never expire. (Available in Paid version.)","pie-register");?>
                </span>
            <?php } ?>
          </div><!-- cols-3 -->
           </div>
