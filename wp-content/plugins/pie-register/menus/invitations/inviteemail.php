...
<?php if(!$this->piereg_pro_is_activate ){ ?>
  <h3 class="inactive-promessage"><?php _e("Available in Paid version","pie-register");?></h3>
<?php }?>
<li class="clearfix">
  <div class="fields">
    <div  class="cols-2">
      ...
      <li class="clearfix">
        <div class="fields">
         ...
         <div class="cols-3">          
          ...
          <br />
          <b onclick="selectText('piereg-select-all-text-onclick_blogname')" id="piereg-select-all-text-onclick_blogname">%blogname%</b> <?php echo _e('Site Title replacement key can be used in email Body','pie-register'); ?>
          </div><!-- cols-3 -->         
        </div>
      </li>
      <li class="clearfix">
