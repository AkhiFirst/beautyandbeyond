	...
	class PieReg_Base extends PieRegisterBaseVariables
	{
		...
		*/
		...
		function install_settings()
		{
			...
			$update['pie_email_content']		= (isset($current["pie_email_content"]) && $current['pie_email_content'])?$current['pie_email_content']: 'Hi there,'.PHP_EOL.PHP_EOL.'You have been invited to create account with Pie Register Development. Click <a href="%invitation_link%">this link</a> to complete registration.'.PHP_EOL.PHP_EOL.'Regards,'.PHP_EOL.get_bloginfo('name');
